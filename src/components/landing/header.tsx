          ...
          {navLinks.map((link) =>
            link.subLinks ? (
              ...
              >
                ...
                {isServicesOpen && (
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-64 z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md animate-in fade-in-0 slide-in-from-top-5 duration-300">
