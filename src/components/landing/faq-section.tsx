...
export function FaqSection() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "มีค่ะ เรามีบริการ IC Visa / Work Permit ที่ดูแลทั้งเรื่องการยื่นขอและต่ออายุ Visa ประเภทต่างๆ รวมถึงใบอนุญาตทำงาน (Work Permit) โดยทีมงานที่สื่อสารภาษาอังกฤษได้ดีและเข้าใจระเบียบข้อบังคับของราชการไทยอย่างละเอียด ช่วยให้ชาวต่างชาติทำธุรกิจในไทยได้อย่างราบรื่นค่ะ",
    },
    {
