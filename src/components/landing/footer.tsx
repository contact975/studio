      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-10">
        <div>
          <div className="flex items-center gap-2 mb-4">
            <BookUser className="h-7 w-7 text-blue-400" />
            <h3 className="text-2xl font-bold text-blue-400">IC Accounting & Service</h3>
          </div>
        ...
        <div className="flex flex-col md:items-end">
          ...
          <div className="flex space-x-4">
            <Link href="#" className="text-gray-300 hover:text-blue-400 transition-colors" prefetch={false}>
              <Facebook className="h-6 w-6" />
              <span className="sr-only">Facebook</span>
            </Link>
            <Link href="https://line.me/ti/p/~" target="_blank" className="text-gray-300 hover:text-blue-400 transition-colors" prefetch={false}>
