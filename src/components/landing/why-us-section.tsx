...
const features = [
  ...
  },
  {
    ...
    description: "เรายึดถือการบริการด้วยใจ ให้คำปรึกษาที่เข้าใจง่าย ไม่ซับซ้อน เพราะเราเชื่อว่าพาร์ทเนอร์ที่ดีต้องคุยกันได้ทุกเรื่อง เราพร้อมเป็น \"เลขาส่วนตัว\" ที่ลงพื้นที่ดูแลคุณถึงหน้างาน เพื่อให้ธุรกิจของคุณเดินหน้าได้อย่างลื่นไหลไม่มีสะดุด",
  },
  {
