  ...
  },
    {
        id: 'accounting-fee-chiangmai',
            title: 'ค่าทำบัญชีเชียงใหม่ ราคาเท่าไหร่? เปรียบเทียบค่าบริการที่ควรรู้',
                content: `ค่าทำบัญชีเชียงใหม่ ราคาเท่าไหร่? เปรียบเทียบค่าบริการที่ควรรู้ในปี 2568
...
ชาวต่างชาติที่ต้องการทำงานในเชียงใหม่ต้องมีใบอนุญาตทำงาน (Work Permit) ก่อนเริ่มทำงาน ไม่ว่าจะเป็นพนักงานประจำ ผู้บริหาร หรือเจ้าของกิจการต่างชาติ บทความนี้อธิบายกระบวนการทั้งหมดอย่างละเอียด ตั้งแต่เอกสารที่ต้องเตรียม ขั้นตอนการยื่นทั้ง 6 ขั้น ค่าใช้จ่ายจริง ไปจนถึงสิ่งที่ต้องทำต่อหลังได้ใบอนุญาตมาแล้ว อ้างอิงจากคู่มือ Non-B Visa & Work Permit ฉบับปรับปรุงล่าสุดของ IC Accounting & Service (กรกฎาคม 2569) ซึ่งเป็นเอกสารชุดเดียวกับที่เราส่งให้ลูกค้า
...
ส่วนที่ 1 เอกสารบริษัทนายจ้าง (12 รายการ):
- หนังสือรับรองการจดทะเบียนบริษัท ฉบับล่าสุด อายุไม่เกิน 6 เดือน
- หนังสือบริคณห์สนธิ และเอกสารการเปลี่ยนแปลงข้อมูลบริษัททั้งหมด
- บัญชีรายชื่อผู้ถือหุ้น (บอจ.5)
- งบการเงินปีล่าสุด พร้อมผู้สอบบัญชีรับรอง
- ภ.ง.ด.50 และ ภ.ง.ด.51 (ภาษีเงินได้นิติบุคคลประจำปีและครึ่งปี)
- ภ.ง.ด.1 และ ภ.พ.30 ย้อนหลัง 3 เดือน (ภาษีหัก ณ ที่จ่าย และภาษีมูลค่าเพิ่ม)
- สปส.1-10 หลักฐานการนำส่งเงินสมทบประกันสังคมทุกเดือน
- ใบทะเบียนภาษีมูลค่าเพิ่ม (ภ.พ.20) และ ภ.พ.01
- แผนที่ตั้งสำนักงาน และภาพถ่ายสถานประกอบการ ทั้งป้ายชื่อ ภายใน และภายนอก
- สำเนาบัตรประชาชนและทะเบียนบ้านของกรรมการผู้มีอำนาจ
- หนังสือรับรองการจ้างงาน หรือหนังสือแต่งตั้ง พร้อมรายละเอียดตำแหน่งงาน
- สัญญาจ้างงาน ระบุตำแหน่ง เงินเดือน และสถานที่ทำงาน

ส่วนที่ 2 เอกสารของผู้ขอ (8 รายการ):
- หนังสือเดินทางตัวจริง อายุเหลือไม่น้อยกว่า 6 เดือน พร้อมสำเนาทุกหน้าที่มีตราประทับ
- รูปถ่ายขนาด 3x4 ซม. พื้นหลังสีขาว จำนวน 6 รูป ถ่ายไม่เกิน 6 เดือน
- หลักฐานการศึกษา ปริญญาบัตรหรือทรานสคริปต์
- หลักฐานประสบการณ์ทำงาน หรือประวัติส่วนตัว (CV, Resume)
- ใบรับรองการทำงานจากนายจ้างเดิม ถ้ามี
- ใบรับรองแพทย์จากโรงพยาบาลในประเทศไทย ใช้ในขั้นตอนขอใบอนุญาตทำงาน
- แบบฟอร์ม ตม.6 และหลักฐานที่พักอาศัยในประเทศไทย (สัญญาเช่า หรือ ตม.30)
- เอกสารทั้งหมดที่เป็นภาษาต่างประเทศ ต้องแปลและรับรองตามที่ราชการกำหนด
...
4. คุณสมบัติของบริษัทผู้ว่าจ้าง

ก่อนเริ่มดำเนินการ บริษัทนายจ้างต้องผ่านเกณฑ์ 3 ข้อนี้ก่อน ถ้าข้อใดข้อหนึ่งไม่ผ่าน จะยื่นขอใบอนุญาตไม่ได้ตั้งแต่ต้น

ทุนจดทะเบียนชำระแล้ว 2,000,000 บาท ต่อชาวต่างชาติ 1 คน

เงินเดือนขั้นต่ำของชาวต่างชาติ 25,000-50,000 บาทต่อเดือน อัตราขึ้นอยู่กับสัญชาติ ตามเกณฑ์ของสำนักงานตรวจคนเข้าเมือง

อัตราส่วนพนักงานไทยในระบบประกันสังคม 4 คน ต่อชาวต่างชาติ 1 คน:
...
5. ขั้นตอนการขอ Work Permit ที่เชียงใหม่ ทั้ง 6 ขั้น

ขั้นตอนที่ 1: เตรียมเอกสารให้ครบทั้งสองชุด คือเอกสารบริษัทและเอกสารผู้ขอ พร้อมตรวจสอบคุณสมบัติทุนจดทะเบียนและอัตราส่วนพนักงานไทยก่อนเริ่ม ใช้เวลา 1-2 สัปดาห์

ขั้นตอนที่ 2: บริษัทยื่นขอหนังสือรับรองการอนุญาตทำงาน ตท.3 (WP.3) ที่สำนักงานจัดหางานจังหวัด เพื่อรับหนังสือรับรองก่อนขอวีซ่า จากนั้นผู้ขอยื่นขอวีซ่า Non-B ที่สถานทูตหรือสถานกงสุลไทยในต่างประเทศ หรือผ่านระบบ Thai e-Visa ใช้เวลา 2-4 สัปดาห์

ขั้นตอนที่ 3: เดินทางเข้าประเทศไทย จะได้รับอนุญาตให้พำนัก 90 วัน ต้องกรอก TDAC (บัตรขาเข้าดิจิทัล) ก่อนเดินทางเข้าทุกครั้ง และเจ้าบ้านหรือผู้ให้เช่าต้องแจ้ง ตม.30 ภายใน 24 ชั่วโมงหลังเข้าพัก

ขั้นตอนที่ 4: ยื่นขอใบอนุญาตทำงานภายใน 90 วันนับจากวันเข้าประเทศ ยื่นที่สำนักงานจัดหางานจังหวัดเชียงใหม่ พร้อมเอกสารตัวจริงของบริษัทและผู้ขอ ต้องมีใบรับรองแพทย์ที่ออกโดยโรงพยาบาลในประเทศไทย ปัจจุบันออกเป็น e-Work Permit (ใบอนุญาตทำงานดิจิทัล) ใช้เวลาพิจารณา 7-15 วันทำการ

ขั้นตอนที่ 5: ต่ออายุการพำนักเป็น 12 เดือน (Extension of Stay) ยื่นที่สำนักงานตรวจคนเข้าเมืองจังหวัดเชียงใหม่ ก่อนสิทธิพำนัก 90 วันสิ้นสุด แนะนำให้ยื่นล่วงหน้า 30-45 วัน โดยใช้ใบอนุญาตทำงานจากขั้นตอนที่ 4 เป็นเอกสารประกอบหลัก พร้อมหลักฐานภาษีและประกันสังคม ใช้เวลา 1-30 วัน

ขั้นตอนที่ 6: เสร็จสิ้นกระบวนการ และเข้าสู่หน้าที่ต่อเนื่องรายปี คือรายงานตัว 90 วัน ต่อวีซ่าและใบอนุญาตทำงานประจำปี และยื่นภาษีเงินได้บุคคลธรรมดา

สรุปกรอบเวลาโดยประมาณ
- เตรียมเอกสาร: 1-2 สัปดาห์
- ตท.3 (WP.3): 7-15 วันทำการ ที่สำนักงานจัดหางานจังหวัด
- วีซ่า Non-B: 5-10 วันทำการ ที่สถานทูตหรือสถานกงสุลไทย
- ใบอนุญาตทำงาน: 7-15 วันทำการ ที่กรมการจัดหางาน
- ต่ออายุพำนัก 12 เดือน: 1-30 วัน ที่สำนักงานตรวจคนเข้าเมือง
- รวมตลอดกระบวนการ: ประมาณ 3-5 เดือน

ระยะเวลาข้างต้นนับจากวันที่เอกสารครบ ไม่ใช่นับจากวันที่ยื่นครั้งแรก เอกสารที่ขาดหรือหมดอายุจะทำให้ต้องเริ่มนับใหม่

6. ค่าใช้จ่ายในการขอ Work Permit

ค่าบริการของ IC Accounting & Service สำหรับกระบวนการเต็มรูปแบบ ตั้งแต่ขอ ตท.3 จนถึงต่ออายุการพำนัก 12 เดือน คือ 112,000 บาท รวมค่าธรรมเนียมราชการแล้ว แบ่งชำระ 3 งวดตามความคืบหน้าของงาน ไม่ต้องจ่ายทั้งก้อนตั้งแต่แรก

- งวดที่ 1 เมื่อยื่นขอวีซ่า Non-B: 45,000 บาท
- งวดที่ 2 ในวันรับใบอนุญาตทำงาน: 22,000 บาท
- งวดที่ 3 เมื่อต่ออายุการพำนัก 12 เดือน: 45,000 บาท
- รวมทั้งสิ้น: 112,000 บาท

ค่าต่ออายุรายปีตั้งแต่ปีที่สองเป็นต้นไป
- ต่ออายุการพำนัก 12 เดือน: 25,000 บาทต่อปี
- ต่ออายุใบอนุญาตทำงาน: 12,000 บาทต่อปี
- รวม 37,000 บาทต่อปี

ค่าใช้จ่ายที่ผู้ขอจ่ายเองแยกต่างหาก
- Re-Entry Permit: 1,000 บาทสำหรับเข้าออกครั้งเดียว หรือ 3,800 บาทแบบหลายครั้ง (ที่สนามบินประมาณ 1,200 บาท) ชำระเป็นเงินสดด้วยตนเองที่ ตม. หรือสนามบิน
- ค่าแปลและรับรองเอกสาร ถ้าจำเป็น
...
แจ้งที่พักอาศัย (TM.30) เจ้าบ้านหรือผู้ให้เช่าต้องแจ้งที่พักของคนต่างด้าวภายใน 24 ชั่วโมง ทุกครั้งที่ย้ายที่อยู่หรือเดินทางกลับเข้าประเทศ

ขอ Re-Entry Permit ก่อนเดินทางออกนอกประเทศทุกครั้ง ถ้าไม่ขอ สิทธิการพำนักจะสิ้นสุดทันทีที่เดินทางออก

ยื่นภาษีเงินได้บุคคลธรรมดา ผู้ถือใบอนุญาตทำงานมีหน้าที่ยื่นแบบ ภ.ง.ด.91 ประจำปี และหลักฐานการเสียภาษีเป็นเอกสารสำคัญในการต่ออายุวีซ่าปีถัดไป

เริ่มดำเนินการต่ออายุล่วงหน้า ใบอนุญาตทำงานเริ่มล่วงหน้า 60 วัน ส่วนวีซ่าเริ่มล่วงหน้า 30-45 วัน ก่อนวันหมดอายุ

บริษัทต้องรักษาคุณสมบัติตลอดเวลา ทั้งทุนจดทะเบียน 2 ล้านบาท และพนักงานไทยในประกันสังคม 4 คนต่อต่างชาติ 1 คน ต้องคงอยู่ตลอดอายุใบอนุญาต มิฉะนั้นอาจไม่ได้รับการต่ออายุ

แจ้งเปลี่ยนแปลง หากเปลี่ยนนายจ้าง เปลี่ยนตำแหน่ง หรือเปลี่ยนที่ตั้งสำนักงาน ต้องดำเนินการแก้ไขใบอนุญาตหรือขอใบใหม่ทุกครั้ง
...
ใช้เวลานานแค่ไหน
เฉพาะขั้นตอนพิจารณาใบอนุญาตทำงานใช้เวลา 7-15 วันทำการ นับจากวันที่เอกสารครบถ้วน แต่ถ้านับตลอดกระบวนการตั้งแต่เตรียมเอกสาร ขอ ตท.3 ขอวีซ่า Non-B ขอใบอนุญาตทำงาน จนถึงต่ออายุการพำนัก 12 เดือน จะใช้เวลาประมาณ 3-5 เดือน

ค่าบริการทั้งหมดเท่าไหร่
ค่าบริการของ IC คือ 112,000 บาท รวมค่าธรรมเนียมราชการ แบ่งชำระ 3 งวด (45,000 / 22,000 / 45,000) และค่าต่ออายุตั้งแต่ปีที่สองคือ 37,000 บาทต่อปี
...
> = {
  ...
  'accounting-fee-chiangmai': {
    ...
    label: 'ดูบริการรับทำบัญชีเชียงใหม่',
  },
