...
import { structuredPosts } from '@/lib/blog-posts';
  ...
  },
  {
  ...
  },
    {
        id: 'accounting-fee-chiangmai',
            title: 'ค่าทำบัญชีเชียงใหม่ ราคาเท่าไหร่? เปรียบเทียบค่าบริการที่ควรรู้',
                                                                                                                                                  ...
                                                                                                                                                  },
                                                                                                                                                    {
                                                                                                                                                        id: 'work-permit-chiangmai',
                                                                                                                                                            title: 'Work Permit เชียงใหม่ ขั้นตอน เอกสาร และค่าใช้จ่ายที่ต้องรู้ ปี 2569',
                                                                                                                                                                excerpt: 'ชาวต่างชาติที่ทำงานในเชียงใหม่ต้องมี Work Permit ก่อนเริ่มงาน บทความนี้อธิบายครบทั้ง 6 ขั้นตอน เอกสาร 20 รายการ คุณสมบัติบริษัทผู้ว่าจ้าง และค่าบริการจริงแบบแบ่งชำระ 3 งวด...',
...
export default function BlogPage() {
  ...
  // บทความใหม่ (มีโครงสร้าง) ขึ้นก่อน ตามด้วยชุดเดิม
  const posts = [...structuredPosts, ...blogPosts];
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-slate-50 text-foreground font-body">
      ...
      <main className="flex-1">
        {/* Hero โทนเดียวกับหน้าบริการ: น้ำเงิน #163674 + ลายตารางจางๆ */}
        <section className="bg-[#163674] text-primary-foreground py-20 md:py-28 relative overflow-hidden">
          <div
